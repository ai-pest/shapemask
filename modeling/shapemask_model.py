...
class ShapeMaskModel(base_model.BaseModel):
  ...
  def _build_outputs(self, images, labels, mode):
    ...
    #if is_training:
    #    tf2.contrib.quantize.create_training_graph(quant_delay=1000)     # DEBUG: added quantization.
    #else:
    #    tf2.contrib.quantize.create_eval_graph()     # DEBUG: added quantization.
    ...
    if is_training:
      ...
      # Use list as input to avoid segmentation fault on TPU.
